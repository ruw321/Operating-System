...
/// LEN_PASS.
///
/// @rblock   enc(padR(pubkey, "REG".aeskey.len(@ablock)))
...
///
/// @rblock   enc(padR(pubkey, "BYE".aeskey.len(@ablock)))
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p)
/// @response enc(aeskey, "OK").<EOF>       -- Success
///           enc(aeskey, error_code).<EOF> -- Error (see @errors)
///           ERR_CRYPTO.<EOF>              -- Error (see @errors)
...
/// assignment.
///
/// @rblock   enc(padR(pubkey, "SAV".aeskey.len(@ablock)))
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p)
/// @response enc(aeskey, "OK").<EOF>       -- Success
///           enc(aeskey, error_code).<EOF> -- Error (see @errors)
///           ERR_CRYPTO.<EOF>              -- Error (see @errors)
...
///
/// @rblock   enc(padR(pubkey, "SET".aeskey.len(@ablock)))
...
///
/// @rblock   enc(padR(pubkey, "GET".aeskey.len(@ablock)))
...
/// LEN_PASS.
///
/// @rblock   enc(padR(pubkey, "ALL".aeskey.len(@ablock)))
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p)
...
///
/// @rblock   enc(padR(pubkey, "KVI".aeskey.len(@ablock)))
...
///
/// @rblock   enc(padR(pubkey, "KVG".aeskey.len(@ablock)))
...
/// LEN_PASS.  @k myst be no more than LEN_KEY bytes.
///
/// @rblock   enc(padR(pubkey, "KVD".aeskey.len(@ablock)))
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p.len(@k).@k)
/// @response enc(aeskey, "OK").<EOF>       -- Success
///           enc(aeskey, error_code).<EOF> -- Error (see @errors)
///           ERR_CRYPTO.<EOF>              -- Error (see @errors)
...
/// LEN_PASS.  @k and @v must conform to LEN_KEY and LEN_VAL.
///
/// @rblock   enc(padR(pubkey, "KVU".aeskey.len(@ablock)))
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p.len(@k).@k.len(@v).@v)
...
/// LEN_PASS.
///
/// @rblock   enc(padR(pubkey, "KVA".aeskey.len(@ablock)))
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p)
/// @response enc(aeskey, "OK".len(@l).@l).<EOF>    -- Success
///           enc(aeskey, error_code).<EOF>         -- Error (see @errors)
///           ERR_CRYPTO.<EOF>                      -- Error (see @errors)
...
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p.len(@m).@m)
/// @response enc(aeskey, "OK".length(@l).@l).<EOF> -- Success
///           enc(aeskey, error_code).<EOF>         -- Error (see @errors)
///           ERR_CRYPTO.<EOF>                      -- Error (see @errors)
/// @errors   ERR_LOGIN       -- @u is not a valid user
...
/// @ablock   enc(aeskey, len(@u).@u.len(@p).@p.len(@m).@m.len(@s).@s)
/// @response enc(aeskey, "OK").<EOF>       -- Success
///           enc(aeskey, error_code).<EOF> -- Error (see @errors)
///           ERR_CRYPTO.<EOF>              -- Error (see @errors)
/// @errors   ERR_LOGIN       -- @u is not a valid user
